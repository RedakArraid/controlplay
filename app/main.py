...
_html_login_page = html_login_page
...
def admin_salle_users(salle_id: int, db: Session = Depends(get_db), _: str = Depends(require_config_admin)):
    ...
    role_ids = get_role_ids(db, roles_wanted + (["salle_admin"] if super_admin else []))
...
from routes.web import web_payments as web_payments_module
from routes.web.web_payments import router as web_payments_router
from routes.web.web_frontend import router as web_frontend_router
from routes.web.web_admin_forms import router as web_admin_forms_router

app.include_router(web_payments_router)
app.include_router(web_frontend_router)
app.include_router(web_admin_forms_router)

checkout = web_payments_module.checkout
